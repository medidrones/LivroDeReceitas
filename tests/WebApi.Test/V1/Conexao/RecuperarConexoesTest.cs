...
public class RecuperarConexoesTest : ControllerBase
{
    private const string METODO = "conexoes";

    private LivroDeReceitas.Domain.Entidades.Usuario _usuarioSemConexao;
    private string _senhaUsuarioSemConexao;

    private LivroDeReceitas.Domain.Entidades.Usuario _usuarioComConexao;
    private string _senhaUsuarioComConexao;

    public RecuperarConexoesTest(WebApiFactory<Program> factory) : base(factory)
    {
