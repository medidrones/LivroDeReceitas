...
public class LoginErroDesconhecidoTest : IClassFixture<LivroReceitaWebApplicationFactorySemDILogin<Program>>
{
    private const string METODO = "login";

    private readonly HttpClient _client;

    public LoginErroDesconhecidoTest(LivroReceitaWebApplicationFactorySemDILogin<Program> factory)
    {
